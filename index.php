...
<body class="font-sans antialiased">
    ...
    <header class="bg-[#121823] sticky top-0 z-50 shadow-lg">
        <div class="container mx-auto container-padding py-3 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="auth.php" class="bg-[#276EF1] hover:bg-[#1F5A89] text-white font-semibold py-2 px-6 rounded-full transition duration-300 flex items-center">
        ...
        <div class="container mx-auto container-padding py-20">
            <div class="max-w-2xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="about.html" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-full transition duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" id="sectors-container">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="p-6">
                        ...
                        <a href="#" class="explore-btn text-blue-600 font-medium hover:text-blue-800 flex items-center transition duration-300">
    ...
    <section class="py-16 bg-gray-100">  <!-- Changed from bg-white to bg-gray-50 -->
        <div class="container mx-auto container-padding text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#" onclick="handleGetStarted()" class="bg-blue-600 text-white hover:bg-blue-700 font-semibold py-3 px-8 rounded-full transition duration-300">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            exploreButtons.forEach(button => {
                button.addEventListener('click', function (e) {
                    ...
                    alert("Please login to show events");
                    window.location.href = "auth.php"; // redirect after clicking OK
                });
            });
        });
        ...
        function handleGetStarted() {
            // Show alert popup
            alert("Please login for Subscription!!!");
            
            // Redirect to auth.php after a short delay (so the alert is visible)
            setTimeout(function() {
