...
<head>
    ...
    <title>ReadyUp - Food & Beverage Events</title>
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <section class="hero-section flex items-center min-h-[50vh]">
        <div class="container mx-auto container-padding py-16 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate_animated animate_fadeInDown">
                Upcoming <span class="gradient-text">Food & Beverage Events</span>
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto animate_animated animatefadeIn animate_delay-1s">
                Discover culinary festivals, wine tastings, cooking workshops, and food industry conferences worldwide.
            </p>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
        <div class="container mx-auto container-padding text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Have a Food Event to Promote?</h2>
            <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                List your culinary event on ReadyUp and reach thousands of food enthusiasts, chefs, and industry professionals.
            </p>
