...
<head>
    ...
    <title>ReadyUp - Finance & FinTech Events</title>
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <section class="hero-section flex items-center min-h-[50vh]">
        <div class="container mx-auto container-padding py-16 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate_animated animate_fadeInDown">
                Upcoming <span class="gradient-text">Finance & FinTech Events</span>
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto animate_animated animatefadeIn animate_delay-1s">
                Discover cutting-edge financial conferences, FinTech expos, investment summits, and blockchain workshops worldwide.
            </p>
    ...
    <section class="py-16 bg-gray-50" id="events">
        <div class="container mx-auto container-padding">
            ...
            $today = date('Y-m-d');
            $conn->query("DELETE FROM finance WHERE date < '$today'");
            $events = $conn->query("SELECT * FROM finance WHERE date >= '$today' ORDER BY date ASC");
            ?>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
        <div class="container mx-auto container-padding text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Have a Finance Event to Promote?</h2>
            <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                List your event on ReadyUp and reach thousands of financial professionals, investors, and FinTech innovators.
            </p>
